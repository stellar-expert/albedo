...
export default function BlockedPageView() {
    ...
    return <div className="v-center-block" style={{minHeight: '80vh'}}>
        ...
        <div className="warning-block">
            <i className="fa fa-warning color-warning"/> The domain <b>{from}</b> has been reported earlier
            ...
            <div className="space text-small">
                <i className="fa fa-warning color-warning"/> Please note: There is no stacking on Stellar.

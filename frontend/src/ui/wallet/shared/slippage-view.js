...
export default function SlippageView({defaultValue = 0.5, max = 5, step = 0.5, title, onChange}) {
    ...
    return <SliderInputLayoutView title={title} validate={validate} valueInput={slippageValue} onChangeInput={onChange} suffix="%">
        <Slider value={defaultValue} min={0.5} max={max} step={step} onChange={changeSlippage} categroies={['0.5%', '5%']}/>
